  ...
  return (
    ...
    <div className="edmphiphai">
      ...
      <div className='input-id-and-button'>
        ...
        <button onClick={()=>{
            const isConfirm = confirm('Đến sheet list?')
            if(!isConfirm){
              return
            }
            window.open('https://docs.google.com/spreadsheets/d/1JC22TNfLkxrzuAROvc8-gZe9gp70qOhEvtTkTIo4WUk/edit?gid=0#gid=0', '_blank');
